        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 order-lg-1 order-2 text-box">
              ...
              {/* Fix: Replace href="#" with valid routes */}
              <a href="/appointment" className="secondary_btn mt-1">
                Appointment
              </a>

              <a href="/about" className="primary-btn mt-1 ms-3">
                Learn More
              </a>
            </div>
            ...
            <div className="col-lg-6 order-lg-2 order-1">
              <img
                ...
                alt="Dentistry professional with patient"
